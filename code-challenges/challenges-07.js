...
const objLat = (obj) => {
    ...
    const information= `my name is ${formattedFirstName} ${formattedLastName} I am ${obj.age} YO, and I love ${obj.hobby}.`;
    return information;
};
// -------------------------------------------------------------------------------------------------------
...
const cvFormatter = (arr) => {
    ...
    for (let cv of arr) {
      ...
      if (yearsOfExperience > 1) {
        ...
        reformattedCvs.push({ fullName, tech });
      }
    }
...
const applicationsStatics = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        const { name, experience, skills } = applicant;
